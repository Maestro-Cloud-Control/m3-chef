...
/**
 * Deletes node with specified name, returns it's last state.
 * See REST description for this command at <a href="http://docs.opscode.com/api_chef_server.html#id27">Chef Server API</a>
 *
 */
public class DeleteNodeCommand extends BasicChefCommand<NodeEntity> {
    private static final String COMMAND_RESOURCE_PREFIX = "nodes/";

    public DeleteNodeCommand(String name) {
