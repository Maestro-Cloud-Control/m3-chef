...
import io.maestro3.chef.client.entity.ClientEntity;

/**
 * Gets API client info for given name.
 * See REST description for this command at <a href="http://docs.opscode.com/api_chef_server.html#id1">Chef Server API</a>
 *
 */
public class GetClientCommand extends BasicChefCommand<ClientEntity> {
    private static final String COMMAND_RESOURCE_PREFIX = "clients/";

    protected GetClientCommand(String name) {
