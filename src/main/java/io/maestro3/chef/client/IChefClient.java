...
package io.maestro3.chef.client;
...
public interface IChefClient {

    <R> IChefResponse<R> execute(IChefCommand<R> command) throws ChefClientException;

    IChefContext getContext();
}
