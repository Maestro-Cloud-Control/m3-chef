 ...
 */
public interface IUserdataCollectingService {

    BasicResponse<OperationResult> updateAutoConfigurationState(String instanceId, String requestIp, AutoConfigurationState state, String chefServer, Set<String> chefRoles) throws PermissionException;
